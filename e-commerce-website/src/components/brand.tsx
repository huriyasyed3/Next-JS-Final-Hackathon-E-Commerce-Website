  ...
  return (
    ...
    <div className='mt-18 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 ml-4'>
         <div className='w-[260px] h-[185px] font-thin  '>
          <TbTruckDelivery size={30} className='  mt-2 '/>
          <h3 className=' text-xl md:text-xl lg:text-xl pt-3'>Next day as standard</h3>
          <p className='pt-2'>Order before 3pm and get your order
          the next day as standard</p>
         </div>
         <div className='w-[260px] h-[185px] font-thin  '>
          <CiCircleCheck size={30} className='  mt-2 '/>
          <h3 className=' text-xl md:text-xl lg:text-xl pt-3'>Made by true artisans</h3>
          <p className='pt-2'>Handmade crafted goods made with
          real passion and craftmanship
          </p>
         </div>
         <div className='w-[260px] h-[185px] font-thin  '>
          <RiSeedlingLine size={30} className='  mt-2 '/>
          <h3 className=' text-xl md:text-xl lg:text-xl pt-3'>Unbeatable prices</h3>
          <p className='pt-2'>For our materials and quality you won’t find better prices anywhere
         </p>
         </div>
         <div className='w-[260px] h-[185px] font-thin  '>
          < FaRegCreditCard size={30} className='  mt-2 '/>
          <h3 className=' text-xl md:text-xl lg:text-xl pt-3'>Recycled packaging</h3>
