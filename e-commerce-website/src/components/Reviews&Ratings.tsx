...
//   return (
//     <div className="max-w-3xl mx-auto p-6 space-y-6 bg-white shadow-lg rounded-xl">
//       <h2 className="text-3xl font-bold text-center text-gray-800">Customer Reviews</h2>
...
//       <form onSubmit={handleSubmitReview} className="bg-gray-100 p-6 rounded-lg shadow-md space-y-4">
...
//           required
//         />
//         <Button type="submit" className="w-full bg-blue-600 hover:bg-blue-700 text-white p-2 rounded-lg">Submit Review</Button>
//       </form>
