...
const Page = async ({ params: { id } }: { params: { id: string } }) => {
 ...
 const handleAddToCart = (product: Product) =>{
  // Update localStorage (if Cart is based on localStorage)
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="flex justify-center">
            <Image
              ...
              width={400}
              height={400}
              className="rounded-lg shadow-lg object-cover md:mr-28"
            />
          </div>

          {/* Product Details */}
          <div className="space-y-6">
            <h1 className="md:text-5xl text-3xl font-extrabold text-purple-900">
              {product.name}
            </h1>
            ...
            <p className="text-gray-700">
        <strong>In Stock:</strong> {product.quantity > 0 ? product.quantity : "Out of Stock"}
            </p>
            <div>
            ...
            <div className="flex gap-4 mt-4 ">
              <Button className="bg-gradient-to-r from-purple-900 to-purple-500  hover:scale-110  text-white
               px-6 py-3 rounded-full text-lg font-semibold shadow hover:bg-blue-600 transition duration-200"
